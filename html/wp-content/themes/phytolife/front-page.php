    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-sm-6">
            ...
            <div class="waku">
                ...
                <span style="color:#000;font-size: 150%;text-shadow: 1px 1px 1px #FFF;font-weight: bold;">小屋の特設サイトがオープン</span>

                <a href="https://niwakoya.jp">
                    <p style="font-weight: bold;color:darkgreen;"><i class="fa fa-angle-double-right" aria-hidden="true"></i> 詳細はこちらから</p>
                </a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-sm-6">
            ...
            <div class="waku">
                <span style="color:#000;font-size: 150%;text-shadow: 1px 1px 1px #FFF;font-weight: bold;">庭の無料相談会を開催中</span>

                <a href="/consultation_2019/">
                    <p style="font-weight: bold;color:darkgreen;"><i class="fa fa-angle-double-right" aria-hidden="true"></i> 詳細はこちらから</p>
                </a>
            </div>
        </div>
